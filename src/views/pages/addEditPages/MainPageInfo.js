...
const MainPageInfo = () => {
  ...
  const handleSubmit = (values) => {
    if (id && id != undefined) {
      ...
      // values.embeddedScript = '<script src="https://cdn.jsdelivr.net/gh/DCP121/article-pages@524f2df867eab9aaa6ce38e5df32af5b23a0acdc/index.js"></script> <div name="page_id" id ="12345"></div>'

...
// get pages 
export const getPage = (navigate,currentPage, rowsPerPage, searchValue, sortDirection, column,lodingFlag) => async (dispatch) => {
    ...
    try {
        ...
        if (response.status === 200) {
            localStorage.setItem('pageApiData', JSON.stringify({currentPage, rowsPerPage, searchValue, sortDirection, column}))

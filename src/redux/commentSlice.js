...
// get comments 
export const getComment = (navigate, currentPage, rowsPerPage, searchValue, sortDirection, column, id, user_id, loadingFlag) => async (dispatch) => {
    ...
    try {
        ...
        if (response.status === 200) {
            localStorage.setItem('commentApiData', JSON.stringify({currentPage, rowsPerPage, searchValue, sortDirection, column, id, user_id}))
